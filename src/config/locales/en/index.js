...
import rewardSystemEN from "./rewardSystem.json";
import spinWheelEN from "./spinWheel.json";
import paymentEn from "./payment.json";
...
const translationsEN = {
  ...
  rewardSystem: rewardSystemEN,
  spinWheel: spinWheelEN,
  payment: paymentEn,
